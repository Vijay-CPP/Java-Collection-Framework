...
public class LinkedHashMapExample {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Size of the LinkedHashMap: " + fruitMap.size()); // 3
        ...
        // Iterating over the key-value pairs in the LinkedHashMap
        System.out.println("LinkedHashMap elements:");
        for (Map.Entry<String, Integer> entry : fruitMap.entrySet()) {
            System.out.println(entry.getKey() + ": " + entry.getValue());
        }

        // Iterating over the keys in the LinkedHashMap
        ...
        // Iterating over the values in the LinkedHashMap
        ...
        fruitMap.clear();
        System.out.println("Is the LinkedHashMap empty? " + fruitMap.isEmpty()); // true

        // Example to show compute fn
        // Adding initial key-value pairs to the LinkedHashMap
        fruitMap.put("Apple", 10);
        fruitMap.put("Banana", 20);
        fruitMap.put("Cherry", 30);
