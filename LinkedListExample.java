...
public class LinkedListExample {
    public static void main(String[] args) {
        ...
        books.add(1, "Hyperion"); // Inserting at index 1
        ...
        // Modifying elements
        books.set(2, "Fahrenheit"); // Replacing element at index 2
        ...
        System.out.println("Contains 'Neuromancer': " + books.contains("Neuromancer")); // Should return true

        // Finding the index of an element
        System.out.println("Index of 'Neuromancer': " + books.indexOf("Neuromancer")); // Should return 3
        System.out.println("Last index of 'Neuromancer': " + books.lastIndexOf("Neuromancer")); // Should return 3

        // Removing elements
        books.remove("Neuromancer"); // Removing by element
